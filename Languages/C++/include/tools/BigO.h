//
// Created by dubjr on 3/27/2017.
//
#include <vector>
#include <stdio.h>

#ifndef GITGOOD_BIGO_H
#define GITGOOD_BIGO_H
...
#error "Your compiler is not supported, yet."
    ...
    template<class T>
    class BigO {
        std::vector<T *> following;

        int getFollowingId(T *item);
    ...
    public:
        ...
        void setupN(T *curr, int N);

        void addOneToCounter(T *curr);

        int getComplexity();
    };
};

#endif //GITGOOD_BIGO_H
